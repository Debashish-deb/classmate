...
import '../../features/auth/pages/enhanced_login_page.dart';
    ...
    redirect: (context, state) async {
      ...
      if (location == '/onboarding') {
        ...
        if (completed) {
          ...
          return isAuthenticated ? '/recording' : '/login';
        }
      }
      
      // Protect authenticated routes
      if (!isAuthenticated && location != '/login' && location != '/register' && location != '/onboarding') {
        return '/login';
      }
